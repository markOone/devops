...
apt-get update
apt-get install -y postgresql postgresql-contrib python3 python3-venv python3-pip nginx git curl
...
sudo -u postgres psql -c "CREATE DATABASE taskdb;"
sudo -u postgres psql -c "CREATE USER appuser WITH ENCRYPTED PASSWORD 'apppass';"
